...
if not isfolder("Mach") then
    makefolder("Mach")
end
if not isfolder("Mach/Config") then
    makefolder("Mach/Config")
end
...
local ConfigFile = "Mach/Config/Mach_" .. gameName .. ".json"
...
local Mach = {}
function Mach:MakeNotify(NotifyConfig)
...
function Mach:Window(GuiConfig)
    ...
    if GuiConfig.Theme then
        ...
        Main.BackgroundColor3 = Color3.fromRGB(25, 10, 10) -- Latar Warna Window
    ...
    DropdownSelectReal.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- Latar Warna Dropdown
